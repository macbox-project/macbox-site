# Sphinx configuration for the MacBox site (https://mac.box/).
#
...
# That is how docs/_extra/CNAME becomes /CNAME. With a custom GitHub Actions
# workflow, the Pages custom-domain setting must still be updated separately.
